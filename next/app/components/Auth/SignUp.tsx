    ...
    return (
        <div className='w-full px-10'>
            <h1 className={`${style.title}`}>
                Sign Up With <span className='text-[crimson]'>Elearning</span>
            </h1>
            <form onSubmit={handleSubmit}>
                ...
                <div className='flex rounded  my-3'>
                    <p className='m-auto flex'><FcGoogle size="30" className="cursor-pointer ml-2" /></p>
                </div>

                <div className='text-center mb-2 dark:text-white'>
                    <h5>Already have any account ? {" "}<span className='text-blue-600 font-bold cursor-pointer pl-1'
